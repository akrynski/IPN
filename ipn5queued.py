...
pages = []
link2names = []
slownik = {u"Imiona:": "imiona", u"Nazwisko:": "nazwisko", u"Nazwisko rodowe:": "nazwisko_rodowe",
           u"Miejsce urodzenia:": "miejsce_urodzenia",
           u"Data urodzenia:": "data_urodzenia", u"Imię ojca:": "imie_ojca", u"Imię matki:": "imie_matki",
           u"Dodatkowe informacje:": "dodatkowe_informacje", u"Znany też jako:": "znany_jako",
           u"Znany\a też jako:": u"znany_jako", u"Znany/a też jako:": u"znany_jako",
...
def getInfo(session, page_link):
    ...
    if info_soup:
        info = info_soup.find("article",
                              {"class": "type-page hentry clearfix"})  # <<<<<<< none type has no attr find !!!!!
...
def start():
    ...
    engine = create_engine('sqlite:///ipn.db', connect_args={'check_same_thread': False}, poolclass=QueuePool,
                           encoding='utf-8')
...
if __name__ == '__main__':
    # import timeit
    import re, requests, sys, getopt, logging  # bs4, webbrowser, io
